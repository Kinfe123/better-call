...
## Purpose and Scope
Better Call is easiest to understand when the major subsystems are visible first. This page explains the real runtime areas in the repository, how they connect, and which reader-facing docs pages to use next.
## Primary Subsystems
...
## Runtime Surfaces
- Frameworks and runtimes appear in this repository through Express.
- The package surface starts from `better-call` and any additional exported entrypoints.
