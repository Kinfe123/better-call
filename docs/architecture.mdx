...
These pages cover architecture for Better Call.

## When to Use This Section
Architecture is the starting point for related workflows in Better Call. Choose the page that matches the workflow, integration, or reference surface you need, then follow its setup and verification guidance.
